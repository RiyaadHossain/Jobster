...
export default function DashboardHome() {
  ...
  if (isFetching || jobFetching || myJobFetching || appliedJobsFetching) return <Loading />
  ...
  return (
    <div className='px-10'>
      ...
      <div className='mt-12 grid grid-cols-4 gap-5'>
        ...
        {role === 'employee' ? <div className='bg-sky-300 stat-card'>
          <h3 className='stat-title'>{myJobs?.data?.length}</h3>
          <p>My Jobs</p>
        </div> : <div className='bg-sky-300 stat-card'>
