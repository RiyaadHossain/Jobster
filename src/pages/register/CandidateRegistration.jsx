...
const CandidateRegistration = () => {
  ...
  const [registerCandidate, { isError, isLoading, isSuccess, data, error }] =
  ...
  return (
    <div className="pt-14 max_container">
      <div
      ...
      <div className="flex justify-center items-center overflow-auto p-10">
        ...
        >
          ...
          <div className="flex  flex-col w-full max-w-xs">
            ...
            />
            {errors.img && (
              <span className="field-error">Image URL is Required</span>
            )}
          </div>
          ...
          <div className="flex flex-col w-full max-w-xs">
            ...
            {errors.country && (
              <span className="field-error">Country is Required</span>
            )}
          </div>
          <div className="flex flex-col w-full max-w-xs">
          ...
          <div className="flex flex-col w-full max-w-xs">
            ...
            <select
              ...
              id="experienceYear"
            >
              <option defaultChecked value="0 - 1">
                0 - 1
              </option>
          ...
          <div className="flex flex-col w-full max-w-xs">
            ...
            <select
              ...
              {...register("candidateType", { required: true })}
              id="candidateType"
            >
          ...
          <div className="flex flex-col w-full max-w-xs">
            ...
            />
            {errors.university && (
              <span className="field-error">University Name is Required</span>
            )}
          </div>
          <div className="flex flex-col w-full max-w-xs">
            ...
            />
            {errors.profession && (
              <span className="field-error">Profession is Required</span>
            )}
          </div>
          <hr className="w-full mt-2 bg-black" />
                ...
                {eduFields.map((item, index) => {
                  return (
                    <div key={index} className=" mb-5 flex items-center gap-3">
                      ...
                      />
                      {errors.education && (
                        <span className="field-error">Skill is Required</span>
                      )}
                      <button
                        type="button"
          ...
          <div className="flex flex-col w-full max-w-xs">
            ...
            />
            {errors.resumeLink && (
              <span className="field-error">Resume Link is Required</span>
            )}
          </div>
          <div className="flex flex-col w-full max-w-xs">
            ...
            />
            {errors.linkedin && (
              <span className="field-error">Linkedin is Required</span>
            )}
          </div>
          <div className="flex flex-col w-full max-w-xs">
            ...
            />
            {errors.github && (
              <span className="field-error">GitHub is Required</span>
            )}
          </div>
          <div className="flex flex-col w-full max-w-xs">
            ...
            />
            {errors.portfolio && (
              <span className="field-error">Portfolio is Required</span>
            )}
          </div>
